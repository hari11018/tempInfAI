                            ...
                            <Grid item >
                                <Stack >
                                    ...
                                    <Typography variant="body2" color={textColor}>
                                        ...
                                        creating a win-win-win situation for brands ,influencers & customers . 
                                    </Typography>
                                </Stack>
                            </Grid>
                ...
                <Container>
                    ...
                    >
                        ...
                        <Stack direction="row" alignItems="center" spacing={{ xs: 3, sm: 1.5, md: 2 }}>
                            <IconButton size="small" component={Link} href="https://www.linkedin.com/company/influence-ai/" target="_blank" aria-label="facebook">
                                <LinkedInIcon sx={{ color: 'text.secondary', '&:hover': { color: 'error.main' } }} />
                            </IconButton>
                            <IconButton size="small" component={Link} href="https://twitter.com/i/flow/login?redirect_after_login=%2FinfluenceAI3375" target="_blank" aria-label="twitter">
                                <TwitterIcon sx={{ color: 'text.secondary', '&:hover': { color: 'primary.main' } }} />
                            </IconButton>
                            <IconButton size="small" component={Link} href="https://www.instagram.com/influenceai.in/" target="_blank" aria-label="instagram">
