            ...
            >
                    ...
                    <Grid container spacing={6}>
                        ...
                        <Grid item xs={12}>
                            <Typography sx={listSX}>
                                ...
                                Harness the Power of Data-Driven Insights across 20+ genres.
                            </Typography>
                            <Typography sx={listSX}>
                                <IconCircleCheck size={20} />
                                Seamless Collaboration & Unrivaled Pricing.
                            </Typography>
                            <Typography sx={listSX}>
                                <IconCircleCheck size={20} />
                                Trusted by 1500+ influencers.
                            </Typography>
                        </Grid>
                        <Grid item xs={12}>
                            <motion.div
                ...
                <Grid item xs={12} md={7} sx={{ display: { xs: 'none', md: 'flex' } }}>
                    <Box sx={{ position: 'relative', mt: 8.75, zIndex: 9 }}>
                        <HeaderImage src={dashboard} alt="InfluenceAI" />
                        <Box
                            sx={{
                                position: 'absolute',
                                top: { md: -35, lg: -110 },
